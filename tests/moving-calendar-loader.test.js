...
describe('moving-calendar-loader load function with  dataset1', function () {
    it('should return an object with a length of 6', function(){
        const data = dataset1();
...
describe('moving-calendar-loader load function with  dataset2', function () {
    it('should return an object with a length of 6', function(){
